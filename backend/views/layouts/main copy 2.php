                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right ">
                        <?php foreach ($notif as $value) : ?>
                            ...
                            <?php foreach ($notiff as $valuee) : ?>
                                <div class=" my-custom-scrollbar">
                                    <?php if ($valuee['tujuan'] = $tanda) { ?>
                                        <?php $isi = Isisurat::find()->where(['id_informasi' => $valuee['id_sk']])->one(); ?>
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <p class="text-sm text-muted"><i class="fa fa-paper-plane"> :</i>
                                                        ...
                                                        <?php $user = User::find()->where(['id' => $tanda["id_user"]])->one(); ?>
                                                        <?php echo $user["username"]; ?>
                                                    </p>
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <p class="text-sm text-muted"><i class="fa fa-paper-plane"> :</i>
                                                        ...
                                                        <?php $user = User::find()->where(['id' => $tujuan["id_user"]])->one(); ?>
                                                        <?php echo $user["username"]; ?>
                                                    </p>
                                                    <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> <?php echo $valuee["created_at"]; ?></p>
                                                </div>
