                ...
                <div class="card ">
                    <div class="card-header" style="background-color: #0093dd;">
                        <h4 class="card-title">
                            ...
                            <?= Html::a('Create', ['signup'], ['class' => 'btn btn-success btn-sm waves-effect waves-light']) ?>
                            ...
                            <tbody>
                                <?php foreach ($user as $value) : ?>
                                    <tr align="center">
                                        ...
                                        <td>
                                            <?php if (!$value["foto"]) { ?>
                                                <image src="<?= Url::toRoute(['upload/user/user2-160x160.jpg']) ?>" height="80" width="70"></image>
                                            <?php } else { ?>
                                                <image src="<?= Url::toRoute(['upload/user/' . $value->foto]) ?>" height="80" width="70"></image>
                                            <?php } ?>
                                        </td>
                                        <td align="right">

                                            <?= Html::a('<span class="fa fa-image"></span>', ['user/update', 'id' => $value->id], ['class' => 'btn btn-success', 'title' => 'Tambahkan Foto']) ?>
